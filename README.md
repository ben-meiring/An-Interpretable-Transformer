...
This project trains a small autoregressive transformer on sequences generated by a known Markov process on the surface of a sphere. Because the underlying token geometry and transition law are known, we can test whether the transformer's learned embeddings and weights recover the structure used to generate the data.
